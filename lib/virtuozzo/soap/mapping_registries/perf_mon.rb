  ...
  module SOAP
    module MappingRegistries
      module PerfMon
        ...
        NsPerf_mon = "http://www.swsoft.com/webservices/vzl/4.0.0/perf_mon"
        NsPerf_mon_0 = "http://www.swsoft.com/webservices/vzl/WSDL/4.0.0/perf_mon"
        ...
        EncodedRegistry.register(
          ...
          :schema_type => XSD::QName.new(NsPerf_mon, "perf_monType"),
          :schema_basetype => XSD::QName.new(NsProtocol, "operator_functionalType"),
          :schema_element => [ :choice,
            ["configuration", ["Virtuozzo::SOAP::Types::PerfMon::ConfigurationType", XSD::QName.new(NsProtocol, "configuration")]],
            ["ok", ["Virtuozzo::SOAP::Types::PerfMon::Perf_monType::Ok[]", XSD::QName.new(NsProtocol, "ok")]],
            ["error", ["Virtuozzo::SOAP::Types::PerfMon::Perf_monType::Error[]", XSD::QName.new(NsProtocol, "error")]],
            [ :choice,
            ...
            [ :choice,
              ["data", "Virtuozzo::SOAP::Types::PerfMon::Perf_dataType[]", [1, nil]],
              ["id", nil]
            ]
          ]
        )
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Perf_monType::Ok,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Perf_monType::Error,
        ...
        EncodedRegistry.register(
          ...
          :schema_type => XSD::QName.new(NsPerf_mon, "classType"),
          :schema_element => [
            ["name", "SOAP::SOAPString"],
            ["instance", "Virtuozzo::SOAP::Types::PerfMon::ClassType::Instance[]", [0, nil]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::ClassType::Instance,
          :schema_name => XSD::QName.new(NsPerf_mon, "instance"),
          :is_anonymous => true,
          :schema_qualified => true,
          :schema_element => [
            ["name", "SOAP::SOAPString", [0, 1]],
            ["counter", "SOAP::SOAPString[]", [0, nil]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Perf_mon_configurationType,
          :schema_type => XSD::QName.new(NsPerf_mon, "perf_mon_configurationType"),
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Env_statusType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::QosType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Env_configType,
          ...
          :schema_element => [
            ...
            ["address", "Virtuozzo::SOAP::Types::PerfMon::Ip_addressType[]", [0, nil]],
            ["architecture", "SOAP::SOAPString", [0, 1]],
            ["os", "Virtuozzo::SOAP::Types::PerfMon::OsType", [0, 1]],
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Venv_configType,
          ...
          :schema_element => [
            ...
            ["base_snapshot_id", nil, [0, 1]],
            ["child_type", "SOAP::SOAPString[]", [0, nil]],
            ["qos", "Virtuozzo::SOAP::Types::PerfMon::QosType[]", [0, nil]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Native_configType,
          :schema_type => XSD::QName.new(NsTypes, "native_configType"),
          :schema_element => []
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::EnvType,
          :schema_type => XSD::QName.new(NsTypes, "envType"),
          :schema_element => [
            ["parent_eid", nil],
            ["eid", nil],
            ["status", "Virtuozzo::SOAP::Types::PerfMon::Env_statusType", [0, 1]],
            ["alert", "SOAP::SOAPInt", [0, 1]],
            ["config", "Virtuozzo::SOAP::Types::PerfMon::Env_configType", [0, 1]],
            ["virtual_config", "Virtuozzo::SOAP::Types::PerfMon::Venv_configType", [0, 1]]
          ]
        )
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Load_avgType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Cpu_loadType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::TransferType::Output,
        ...
        EncodedRegistry.register(
          ...
          :schema_element => [
            ...
            ["login", "Virtuozzo::SOAP::Types::PerfMon::System_nodeType::Login", [0, 1]]
          ]
        )
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::System_nodeType::Login,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::IntervalType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Net_addressType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Net_classType,
          :schema_type => XSD::QName.new(NsTypes, "net_classType"),
          :schema_element => [
            ["id", "SOAP::SOAPString", [0, 1]],
            ["transfer", "Virtuozzo::SOAP::Types::PerfMon::TransferType", [0, 1]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Ip_rangeType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Sample_confType,
          ...
          :schema_element => [
            ...
            ["vt_version", "Virtuozzo::SOAP::Types::PerfMon::Sample_confType::Vt_version", [0, 1]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Sample_confType::Vt_version,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Sys_infoType,
          ...
          :schema_element => [
            ...
            ["memory", "Virtuozzo::SOAP::Types::PerfMon::Sys_infoType::Memory", [0, 1]],
            ["swap", "Virtuozzo::SOAP::Types::PerfMon::Sys_infoType::Swap", [0, 1]]
          ]
        )
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Sys_infoType::Swap,
        ...
        EncodedRegistry.register(
          ...
          :schema_element => [
            ["process", "Virtuozzo::SOAP::Types::PerfMon::Ps_infoType::C_Process[]", [1, nil]],
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Ps_infoType::C_Process,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Load_avg_statsType,
          :schema_type => XSD::QName.new(NsTypes, "load_avg_statsType"),
          :schema_element => [
            ["l1", "Virtuozzo::SOAP::Types::PerfMon::Load_avg_statsType::L1"],
            ["l2", "Virtuozzo::SOAP::Types::PerfMon::Load_avg_statsType::L2", [0, 1]],
            ["l3", "Virtuozzo::SOAP::Types::PerfMon::Load_avg_statsType::L3", [0, 1]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Load_avg_statsType::L1,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Load_avg_statsType::L2,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Load_avg_statsType::L3,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Ip_addressType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Env_resourceType,
          :schema_type => XSD::QName.new(NsTypes, "env_resourceType"),
          :schema_element => [
            ["eid", nil],
            ["ip_pool", "Virtuozzo::SOAP::Types::PerfMon::Ip_poolType", [0, 1]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Ip_poolType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Ip_poolType::Ip_range,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Root_credentialType,
          ...
          :schema_element => [
            ...
            ["description", "SOAP::SOAPBase64", [0, 1]],
            ["cred", "Virtuozzo::SOAP::Types::PerfMon::CredentialType[]", [0, nil]],
            ["objects", "Virtuozzo::SOAP::Types::PerfMon::Root_credentialType::Objects", [0, 1]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Root_credentialType::Objects,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::CredentialType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::TokenType,
          :schema_type => XSD::QName.new(NsTypes, "tokenType"),
          :schema_element => [
            ["user", nil],
            ["groups", "Virtuozzo::SOAP::Types::PerfMon::TokenType::Groups", [0, 1]],
            ["deny_only_sids", "Virtuozzo::SOAP::Types::PerfMon::TokenType::Deny_only_sids", [0, 1]],
            ["privileges", "Virtuozzo::SOAP::Types::PerfMon::TokenType::Privileges", [0, 1]],
            ["source", "Virtuozzo::SOAP::Types::PerfMon::TokenType::Source", [0, 1]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::TokenType::Groups,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::TokenType::Deny_only_sids,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::TokenType::Privileges,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::TokenType::Source,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Connectivity_infoType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Auth_nameType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Connection_infoType,
          ...
          :schema_element => [
            ...
            ["address", "SOAP::SOAPString"],
            ["port", "SOAP::SOAPUnsignedInt", [0, 1]],
            ["login", "Virtuozzo::SOAP::Types::PerfMon::Auth_nameType", [0, 1]],
            ["password", "SOAP::SOAPBase64", [0, 1]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Eid_listType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Vt_infoType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Vt_settingsType,
        ...
        EncodedRegistry.register(
          ...
          :schema_element => [
            ["initial_group", "Virtuozzo::SOAP::Types::PerfMon::UserType::Initial_group", [0, 1]],
            ["group", "Virtuozzo::SOAP::Types::PerfMon::UserType::Group[]", [0, nil]],
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::UserType::Initial_group,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::UserType::Group,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::GroupType,
          :schema_type => XSD::QName.new(NsTypes, "groupType"),
          :schema_element => [
            ["user", "Virtuozzo::SOAP::Types::PerfMon::GroupType::User[]", [0, nil]],
            ["member_group", "Virtuozzo::SOAP::Types::PerfMon::GroupType::Member_group[]", [0, nil]],
            ["name", "SOAP::SOAPString", [0, 1]],
            ["gid", "SOAP::SOAPInt", [0, 1]]
          ]
        )
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::GroupType::User,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::GroupType::Member_group,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Event_dataType,
          :schema_type => XSD::QName.new(NsTypes, "event_dataType"),
          :schema_element => []
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Named_listType,
        ...
        EncodedRegistry.register(
          ...
          :schema_element => [
            ...
            ["data", "Virtuozzo::SOAP::Types::PerfMon::EventType::C_Data", [0, 1]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::EventType::C_Data,
        ...
        EncodedRegistry.register(
          ...
          :schema_element => [
            ...
            ["translate", nil, [0, 1]],
            ["parameter", "Virtuozzo::SOAP::Types::PerfMon::InfoType[]", [0, nil]],
            ["name", "SOAP::SOAPString"]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::AceType,
        ...
        EncodedRegistry.register(
          ...
          :schema_element => [
            ["owner", nil],
            ["group", nil],
            ["dacl", "Virtuozzo::SOAP::Types::PerfMon::Security_descriptorType::Dacl", [0, 1]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Security_descriptorType::Dacl,
          :schema_name => XSD::QName.new(NsTypes, "dacl"),
          :is_anonymous => true,
          :schema_qualified => true,
          :schema_element => [
            ["ace", "Virtuozzo::SOAP::Types::PerfMon::AceType[]", [0, nil]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Env_security_objectType,
        ...
        EncodedRegistry.register(
          ...
          :schema_element => [
            ["id", "SOAP::SOAPString", [0, 1]],
            ["ip_address", "Virtuozzo::SOAP::Types::PerfMon::Ip_addressType[]", [0, nil]],
            ["dhcp", nil, [0, 1]],
            ["network_id", "SOAP::SOAPBase64", [0, 1]],
            ["status", "Virtuozzo::SOAP::Types::PerfMon::Net_deviceType::Status", [0, 1]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Net_deviceType::Status,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Voc_parameterType,
        ...
        EncodedRegistry.register(
          ...
          :schema_element => [
            ["name", "SOAP::SOAPString"],
            ["parameter", "Virtuozzo::SOAP::Types::PerfMon::Voc_parameterType[]", [0, nil]],
            ["category", "Virtuozzo::SOAP::Types::PerfMon::Voc_parameterType[]", [0, nil]]
          ]
        )
        ...
        EncodedRegistry.register(
          ...
          :schema_element => [
            ...
            ["dhcp", nil, [0, 1]],
            ["network_id", "SOAP::SOAPBase64", [0, 1]],
            ["status", "Virtuozzo::SOAP::Types::PerfMon::Net_nicType::Status", [0, 1]],
            ["mac_address", "SOAP::SOAPString", [0, 1]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Net_nicType::Status,
          :schema_name => XSD::QName.new(NsTypes, "status"),
          :is_anonymous => true,
          :schema_qualified => true,
          :schema_element => [ :choice,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Perf_statType,
        ...
        EncodedRegistry.register(
          ...
          :schema_element => [
            ["eid", nil],
            ["v_class", ["Virtuozzo::SOAP::Types::PerfMon::Perf_dataType::C_Class[]", XSD::QName.new(NsTypes, "class")], [0, nil]],
            ["interval", "Virtuozzo::SOAP::Types::PerfMon::IntervalType"]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Perf_dataType::C_Class::Instance::Counter,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Perf_dataType::C_Class::Instance,
          :schema_name => XSD::QName.new(NsTypes, "instance"),
          :is_anonymous => true,
          :schema_qualified => true,
          :schema_element => [
            ["name", "SOAP::SOAPString", [0, 1]],
            ["counter", "Virtuozzo::SOAP::Types::PerfMon::Perf_dataType::C_Class::Instance::Counter[]", [1, nil]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Perf_dataType::C_Class,
          :schema_name => XSD::QName.new(NsTypes, "class"),
          :is_anonymous => true,
          :schema_qualified => true,
          :schema_element => [
            ["name", "SOAP::SOAPString"],
            ["instance", "Virtuozzo::SOAP::Types::PerfMon::Perf_dataType::C_Class::Instance[]", [1, nil]]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Log_options_baseType,
          :schema_type => XSD::QName.new(NsTypes, "log_options_baseType"),
          :schema_element => []
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Log_optionsType,
        ...
        EncodedRegistry.register(
          ...
          :schema_element => [
            ["auth", "Virtuozzo::SOAP::Types::PerfMon::AuthType", [0, 1]],
            ["cookie", "SOAP::SOAPString", [0, 1]],
            ["target", "SOAP::SOAPString[]", [0, nil]],
            ["origin", "SOAP::SOAPString", [0, 1]],
            ["src", "Virtuozzo::SOAP::Types::PerfMon::RouteType", [0, 1]],
            ["dst", "Virtuozzo::SOAP::Types::PerfMon::RouteType", [0, 1]],
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Operator_functionalType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Operator_functionalType::Ok,
          :schema_name => XSD::QName.new(NsProtocol, "ok"),
          :is_anonymous => true,
          :schema_qualified => true,
          :schema_element => []
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Operator_functionalType::Error,
          :schema_name => XSD::QName.new(NsProtocol, "error"),
          :is_anonymous => true,
          :schema_qualified => true,
          :schema_element => [
        ...
        EncodedRegistry.register(
          ...
          :schema_element => [ :choice,
            ...
            [ :choice,
              ...
              ["set_period", "Virtuozzo::SOAP::Types::PerfMon::Set_periodType", [0, 1]],
              ["report", nil, [0, 1]]
            ]
          ]
        )
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Operator_periodicType::Ok,
          :schema_name => XSD::QName.new(NsProtocol, "ok"),
          :is_anonymous => true,
          :schema_qualified => true,
          :schema_element => []
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Operator_periodicType::Error,
          :schema_name => XSD::QName.new(NsProtocol, "error"),
          :is_anonymous => true,
          :schema_qualified => true,
          :schema_element => [
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Set_periodType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Start_monitorType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Stop_monitorType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::AuthType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Event_configurationType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Periodic_configurationType,
        ...
        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::DataType,
          :schema_type => XSD::QName.new(NsProtocol, "dataType"),
          :schema_element => [
            ["operator", "Virtuozzo::SOAP::Types::PerfMon::OperatorType[]"]
          ]
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::ConfigurationType,
          :schema_type => XSD::QName.new(NsProtocol, "configurationType"),
          :schema_element => []
        )

        EncodedRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Transport_type,
        ...
        LiteralRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Packet_headerType,
          :schema_name => XSD::QName.new(NsPerf_mon_0, "packet_header"),
          :schema_element => [
            ["auth", "Virtuozzo::SOAP::Types::PerfMon::AuthType", [0, 1]],
            ["cookie", "SOAP::SOAPString", [0, 1]],
            ["target", "SOAP::SOAPString[]", [0, nil]],
        ...
        LiteralRegistry.register(
          ...
          :schema_name => XSD::QName.new(NsPerf_mon, "perf_mon"),
          :schema_element => [
            ["configuration", ["Virtuozzo::SOAP::Types::PerfMon::ConfigurationType", XSD::QName.new(NsProtocol, "configuration")]],
            ["ok", ["Virtuozzo::SOAP::Types::PerfMon::Perf_mon::Ok[]", XSD::QName.new(NsProtocol, "ok")]],
            ["error", ["Virtuozzo::SOAP::Types::PerfMon::Perf_mon::Error[]", XSD::QName.new(NsProtocol, "error")]],
            [ :choice,
              ["start_monitor", "Virtuozzo::SOAP::Types::PerfMon::Start_monitor"],
              ["stop_monitor", "Virtuozzo::SOAP::Types::PerfMon::Stop_monitor"],
              ["get", "Virtuozzo::SOAP::Types::PerfMon::Get"]
        ...
        LiteralRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Perf_mon::Ok,
          :schema_name => XSD::QName.new(NsProtocol, "ok"),
          :is_anonymous => true,
          :schema_qualified => true,
          :schema_element => []
        ...
        LiteralRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Perf_mon::Error,
          :schema_name => XSD::QName.new(NsProtocol, "error"),
          :is_anonymous => true,
          :schema_qualified => true,
          :schema_element => [
        ...
        LiteralRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Start_monitor,
          :schema_name => XSD::QName.new(NsPerf_mon, "start_monitor"),
          :schema_element => [
            ["eid_list", "Virtuozzo::SOAP::Types::PerfMon::Eid_listType"],
            ["filter", "Virtuozzo::SOAP::Types::PerfMon::Start_monitor::Filter", [0, 1]],
            ["v_class", ["Virtuozzo::SOAP::Types::PerfMon::ClassType[]", XSD::QName.new(NsPerf_mon, "class")], [1, nil]],
            ["report_period", "SOAP::SOAPInt"],
            ["collect_period", "SOAP::SOAPInt", [0, 1]]
          ]
        )

        LiteralRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Start_monitor::Filter,
          :schema_name => XSD::QName.new(NsPerf_mon, "filter"),
          :is_anonymous => true,
          :schema_qualified => true,
          :schema_element => [
        ...
        LiteralRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Stop_monitor,
          :schema_name => XSD::QName.new(NsPerf_mon, "stop_monitor"),
          :schema_element => [
            ["id", nil]
          ]
        )
        ...
        LiteralRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Perf_dataType,
          :schema_name => XSD::QName.new(NsPerf_mon, "data"),
          :schema_element => [
            ["eid", nil],
            ["v_class", ["Virtuozzo::SOAP::Types::PerfMon::Perf_dataType::C_Class[]", XSD::QName.new(NsTypes, "class")], [0, nil]],
            ["interval", "Virtuozzo::SOAP::Types::PerfMon::IntervalType"]
        ...
        LiteralRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Get,
          :schema_name => XSD::QName.new(NsPerf_mon, "get"),
          :schema_element => [
            ["eid_list", "Virtuozzo::SOAP::Types::PerfMon::Eid_listType"],
            ["v_class", ["Virtuozzo::SOAP::Types::PerfMon::ClassType[]", XSD::QName.new(NsPerf_mon, "class")], [1, nil]]
          ]
        ...
        LiteralRegistry.register(
          ...
          :schema_name => XSD::QName.new(NsPerf_mon, "start_monitorResponse"),
          :schema_element => [
            ["id", nil]
          ]
        )
        ...
        LiteralRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Stop_monitorResponse,
          :schema_name => XSD::QName.new(NsPerf_mon, "stop_monitorResponse"),
          :schema_element => []
        )

        LiteralRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::GetResponse,
          :schema_name => XSD::QName.new(NsPerf_mon, "getResponse"),
          :schema_element => [
            ["data", "Virtuozzo::SOAP::Types::PerfMon::Perf_dataType[]", [1, nil]]
          ]
        )
        ...
        LiteralRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Packet,
        ...
        LiteralRegistry.register(
          :class => Virtuozzo::SOAP::Types::PerfMon::Packet::C_Data,
